...
Route::middleware('autenticacao')->prefix('/app')->group(function(){
    ...
    Route::delete('/pedido-prodtuo.destroy/{pedidoProduto}/{pedido_id}',[\App\Http\Controllers\PedidoProdutoController::class,'destroy'])->name('pedido-produto.destroy');
...
Route::fallback(function(){
    echo 'A rota acessa não existe. <a href=" '.route('site.index').' ">Clique aqui</a> para ir para página inicial';
});
